...
export const ActivityCard = ({ title, subtitle, time, icon, color }: { title: string, subtitle: string, time: string, icon: keyof typeof Ionicons.glyphMap, color: string }) => (
  <View className="flex-row items-center bg-white dark:bg-surface-dark px-4 py-3 rounded-2xl mb-2 mx-6 border border-gray-100 dark:border-gray-800">
